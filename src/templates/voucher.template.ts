    ...
    <div class="section">
      ...
      <div class="info-grid" style="margin-bottom: 12px;">
        ...
        <div class="info-item">
          ...
          <div class="info-value" style="font-size:13px; word-break: break-all;"><a href="${data.villaLocation}" style="color:#1A1A1A; text-decoration:underline;" target="_blank">${data.villaLocation}</a></div>
        </div>
      </div>
